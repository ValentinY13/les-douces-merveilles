<template>
  <ul class="w-full text-xl text-brown-700 text-center flex items-center pb-6">
    ...
    <li class="h-px w-full"
        :class="{'bg-brown-700 opacity-100': step >= 3, 'bg-brown-700 opacity-50': step < 3}"></li>
    <li
        ...
        :class="{'border-brown-700 bg-brown-700 text-white opacity-100 after:text-brown-700': step >= 3, 'border-brown-700 opacity-50': step < 3}"></li>
  </ul>
</template>
