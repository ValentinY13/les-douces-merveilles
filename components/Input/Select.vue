  ...
  <div ref="dropdownRef">
    ...
    <div class="relative">
      ...
      <button
          ...
          class="cursor-pointer py-2 px-4 text-xs bg-bg-primary flex items-center text-left gap-3 w-full hover:ring-1 hover:ring-brown-700 disabled:bg-grey-100 disabled:hover:ring-0 disabled:cursor-not-allowed"
        ...
        <span class="overflow-hidden whitespace-nowrap text-ellipsis flex-1 text-grey-700">{{
      ...
      <transition name="fade-top">
        <ul v-if="isOpen"
          ...
          <li
              class="py-2 px-6 cursor-pointer border-b-[1px] border-b-grey-700 last:border-b-0 hover:bg-brown-700 hover:text-white"
