...
<template>
  <div>
    <h2 class="text-h3-medium text-brown-700 text-center my-8">J'ai déjà un compte</h2>
    <p class="my-2 text-center">Connectez-vous si possédez déjà un compte</p>
    <form @submit="submitForm" class="grid grid-cols-1 gap-6 mt-6">
      <InputText type="email" input-id="basket-email" name="email" placeholder="Votre adresse e-mail">
        <label for="email">Adresse e-mail*</label>
      </InputText>
      <InputText :type="showInput ? 'text' : 'password'" input-id="basket-password" name="password"
