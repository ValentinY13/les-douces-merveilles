export type BlockCitation = {
    background: DirectusFiles;
    id: number;
    text?: string | null;
};
...
export type BlockHeader = {
    id: number;
    slides: BlockHeaderSlides[];
};

export type BlockHeaderSlides = {
    id: number;
    product: Product;
    slide?: number | BlockHeader;
    sort?: number | null;
    title?: string | null;
};
...
export type BlockSlider = {
    id: number;
    product: any[] | BlockSliderProduct[];
    subtitle?: string | null;
    title?: string | null;
};

export type BlockSliderProduct = {
    block_slider_id?: number | BlockSlider | null;
    id: number;
...
export type Home = {
    blocks: any[] | HomeBlocks[];
    id: number;
};

export type HomeBlocks = {
    collection?: string | null;
    home_id?: number | Home | null;
    id: number;
...
export type SubCategory = {
    categorie?: number | Category | null;
    date_created?: string | null;
    date_updated?: string | null;
    id: number;
    name?: string | null;
...
export type CustomDirectusTypes = {
    ...
    block_header_slides: BlockHeaderSlides[];
    block_slider: BlockSlider[];
    block_slider_product: BlockSliderProduct[];
    cart: Cart[];
    cart_item: CartItem[];
    category: Category[];
